...
export const Text4 = "With the item %s, I can <!--break-->evolve! I'm yearning to evolve! Help!"
export const Text5 = "The %s! What I love to eat <!--break-->and can't live without! Please get one!"
export const Text9 = "This is a rescue through communication. <!--break-->Get a friend to help you!"
export const Text10 = "This is a rescue through communication. <!--break-->Rescue a friend!"
export const Text11 = "This is a rescue through communication. <!--break-->Send your thanks to your friend!"
export const MankeyTitle = "Punish bad Mankey!"
export const SmeargleTitle = "Smeargle's desperate plea!"
export const MedichamTitle = "Medicham: Help me!"
export const Title4 = "Save my child!"
export const Title6 = "Escort me to my love!"
export const Title7 = "Deliver one %s."
export const Title11 = "One %s wanted!"
export const Title12 = "Deliver one %s."
export const Title8 = [
    "Help!",
    "I can't get out!",
    "I'm in trouble...",
